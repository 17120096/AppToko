...
import com.example.apptoko.response.itemTransaksi.ItemTransaksiResponsePost
...
class BayarFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val etPenerimaan = view.findViewById<EditText>(R.id.etPenerimaan)
        etPenerimaan.addTextChangedListener(object : TextWatcher {
...
//
                if (etPenerimaan.text.toString() != "") {
                    val penerimaan: Int = etPenerimaan.text.toString().toInt()
        ...
        btnSimpanBayar.setOnClickListener {
            ...
            ).enqueue(object : Callback<TransaksiResponsePost> {
